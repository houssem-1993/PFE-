import { NEWS_LIST_REQUEST,NEWS_LIST_SUCCESS,NEWS_LIST_FAIL, NEWS_DETAILS_REQUEST, NEWS_DETAILS_SUCCESS, NEWS_DETAILS_FAIL, NEWS_DELETE_REQUEST, NEWS_DELETE_SUCCESS, NEWS_DELETE_FAIL, NEWS_CREATE_REQUEST, NEWS_CREATE_SUCCESS, NEWS_CREATE_FAIL, NEWS_CREATE_RESET, NEWS_UPDATE_REQUEST, NEWS_UPDATE_SUCCESS, NEWS_UPDATE_FAIL, NEWS_UPDATE_RESET } from "../constants/newsConstants"


export const newsListReducer=(state = {news: []},action) => {
    switch(action.type){
        case NEWS_LIST_REQUEST:
            return{loadin:true,news:[]}
        case NEWS_LIST_SUCCESS:
            return{loadin:false,news:action.payload}
        case NEWS_LIST_FAIL:
            return {loadin:false,erro:action.payload}
        default:
            return state
    }
}
...
export const newsDeleteReducer = (state = {},action) => {
    switch(action.type){
        ...
        case NEWS_DELETE_SUCCESS:
            return{loadin:false,succes:true}
